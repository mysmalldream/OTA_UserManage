...
(function(jq){
	...
	posterTvGrid.prototype = {
		...
		initContent: function(){
			...
			this.parent.find(".contentHolderUnit:nth-child("+this.pageNow+")").css({width:'1000px',height:'350px', opacity: 1, left: this.pageNowLeft+'px', zIndex: 3, marginTop: 0});
			...
			this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 1, left: this.preLeft+'px',height: '260px', width: '530px', zIndex: 0, marginTop: '23px'});
			...
			this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 1, left: this.nextLeft+'px',height: '260px', width: '530px', zIndex: 0, marginTop: '23px'});
		...
		turnpage: function(page, dir){
			...
			var run = function(page, dir, t){
				...
				if(dir == 'left'){					
					...
					_this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: '260px', width: '530px', zIndex: 2, marginTop: '23px'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: '350px', width: '1000px', zIndex: 3, marginTop: '0'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+next+")").animate({opacity: 1, left: _this.nextLeft+'px', height: '260px', width:"530px", zIndex: 2, marginTop: '23px'}, t);
					...
					_this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: '350px', width: '1000px', zIndex: 3, marginTop: '0px'}, t);
					_this.parent.find(".contentHolderUnit:nth-child("+page+") .elementOverlay").css({opacity:0});
					_this.parent.find(".contentHolderUnit:nth-child("+page+") .leftShadow").css({opacity:1});
					_this.parent.find(".contentHolderUnit:nth-child("+page+") .rightShadow").css({opacity:1});
